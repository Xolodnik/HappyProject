...
/**
 * Created by Mikita on 25-May-18.
 *
...
public class HappyHeightsRunner {
...
//            if(getPattern(listOfNum).size() != 0)
                System.out.println(a+ "\t"+ getPattern(listOfNum) +"\t"+ (height-getPattern(listOfNum).size()));
